  ...
  return (
    ...
    <div className="h-[80vh] w-full bg-white dark:bg-gray-950 flex justify-center items-center">
      <div className="mt-10 text-center flex justify-center flex-col mx-6">
        ...
        <h1 className="mt-12 text-gray-700 dark:text-white font-bold text-[26px]">Setup your <b className="text-sky-400">Username</b></h1>
        <p className="mt-3 text-gray-600 dark:text-gray-300 dark:text-gray-600">Hello there <b className="text-sky-400">{user.email}</b> please setup your username to continue with Linktr3</p>
